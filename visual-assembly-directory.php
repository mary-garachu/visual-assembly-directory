 ...
 */
if ( ! function_exists( 'vad_register_custom_post_type' ) ) {
...
/**
 * Load Plugin Archive Template
 */
if ( ! function_exists( 'vad_load_archive_template' ) ) {
 ...
 */
if ( ! function_exists( 'vad_enqueue_plugin_styles' ) ) {
    function vad_enqueue_plugin_styles() {
        wp_enqueue_style(
            'vad-main-style',
        ...
        wp_enqueue_style(
            'vad-events-style',
            plugin_dir_url( __FILE__ ) . 'assets/css/events-feed.css',
            array(),
            '1.0'
        );
    }
    add_action( 'wp_enqueue_scripts', 'vad_enqueue_plugin_styles' );
}
